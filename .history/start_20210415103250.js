...
switch (color) {
    case "red":
        ...
        break;
    case "green":
        console.log("green" + " yey its green color ");
        break
    case "blue":
        console.log("blue");
        break;
...
switch (grades) {
    case "one":
        console.log("25 so sorry to that");
        break
    case "two":
        console.log("50 so sorry to that");
        break
    case "three":
        console.log("75 good job");
        break
    case "one":
        console.log("100 you are a machine");
        break
